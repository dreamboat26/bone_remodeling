...
End‑to‑end pipeline for unsupervised analysis of H&E whole‑slide images (`.mrxs` format). The pipeline extracts tissue patches, computes deep features with DINOv2, clusters patches to discover histological states, and generates spatial maps and visualisations.
